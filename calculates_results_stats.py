...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # if label matchs, increase value of n_match key by 1
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1 

                
        
        # if pet image is a dog and label match, increase number of correct breeds by 1
        if results_dic[key][3] == 1 and results_dic[key][2] == 1:
            results_stats_dic['n_correct_breed'] +=1
        
        
        # if pet image is a dog increase number of dogs by 1
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            
            
            # if image is classified as a dog and it's really dog, increase it by 1
