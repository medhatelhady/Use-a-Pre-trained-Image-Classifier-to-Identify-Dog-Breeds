...
def get_pet_labels(image_dir):
    ...
    for i in range(len(filename_list)):
        ...
        if filename_list[i][0] != ".":
            ...
            if filename_list[i] not in results_dic.keys():
            # make all letters small, replace _ to white space and remove last part  
                results_dic[filename_list[i]] = [pet_label]
            
            
            
            # print error message if file not founded
            else:
